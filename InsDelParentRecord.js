...
(function() {
  "use strict";
  const c_sbmt = 'app.record.create.submit';
  const d_del_sbmt = 'app.record.detail.delete.submit';
  const i_del_sbmt = 'app.record.index.delete.submit';
  const edt_sbmt = 'app.record.edit.submit';
  const i_edt_sbmt = 'app.record.index.edit.submit';
      ...
      function(resp) {
        ...
        switch(event.type) {
          ...
          case i_edt_sbmt:
            ...
            if (subTotal == subTotalPrev) { return; }
